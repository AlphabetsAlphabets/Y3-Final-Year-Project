...
type LayoutRouteId = RouteId | "/summary" | "/summary/[name]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/summary/+layout.server.js').load>>>>>>;
