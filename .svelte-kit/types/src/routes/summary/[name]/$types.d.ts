...
type LayoutRouteId = RouteId | "/summary/[name]"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/summary/[name]/+page.server.js').load>>>>>>;
